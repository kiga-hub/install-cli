...
export const defaultTheme = Object.freeze({
    brand: Object.freeze(["#00C2FF", "#00E6A8"]),
    accent: "#F6C177",
    success: "#2ED573",
    warn: "#FFA502",
    error: "#FF4757",
...
const StepLogInputSchema = z.preprocess((value) => {
...
const ThemeSchema = z
    ...
    brand: z
        ...
        .default(() => [defaultTheme.brand[0], defaultTheme.brand[1]]),
    ...
    .default(() => ({
    brand: [defaultTheme.brand[0], defaultTheme.brand[1]],
...
export async function resolveConfigPath(cliPath) {
    if (cliPath) {
