...
export async function runSteps(config, options, emitter) {
...
export async function runSingleStep(config, options, emitter, index) {
...
async function runSimulatedStep(step, options, emitter, context) {
...
async function runSystemCheckStep(step, options, emitter, context) {
...
async function runCommandStep(step, options, emitter, context) {
    ...
    await new Promise((resolve, reject) => {
        ...
        stderr?.on("line", (line) => emitter.emit("step:log", { level: "info", message: line, step, index: context.index }));
        let percent = 0;
